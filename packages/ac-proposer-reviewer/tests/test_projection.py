...
from ac_proposer_reviewer.artifacts import (
    proposal_artifact_id,
    review_artifact_id,
    transcript_artifact_id,
)
from ac_proposer_reviewer.dialogue import TranscriptTurn, encode_transcript_turn
...
from ac_proposer_reviewer.projection import (
...
def test_paused_loop_uses_safe_pause_summary(tmp_path: Path) -> None:
    ...
    paused = _PauseRecord(
        ...
        Awaiting(
            ...
            details={
                ...
                "provider_failure": {
                    "category": "transport",
                    "ac_error_code": "provider_transport",
    ...
    assert pause_entry.provider_failure.ac_error_code == "provider_transport"
...
def test_provider_failure_summary_rejects_non_ac_diagnostic_ids(
    artifact_id: str,
) -> None:
    record = _PauseRecord(
        "proposer",
...
def test_inspection_marks_truncated_runtime_activity_history(
    ...
    monkeypatch.setattr(
        "ac_proposer_reviewer.projection.EventWriter",
        TruncatedEvents,
    )
