...
from ac_proposer_reviewer.identity import (
...
from ac_proposer_reviewer.models import LoopSpec, RevisionContextMode, WorkerSpec
from ac_proposer_reviewer.prompts import (
    PROMPT_CONTRACT,
...
def test_worker_identity_covers_only_current_worker_contract() -> None:
    ...
    assert PROMPT_CONTRACT == "ac.proposer_reviewer.prompt.v3"
