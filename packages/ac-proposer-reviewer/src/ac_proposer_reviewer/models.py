...
@dataclass(frozen=True)
class BatchRequest:
    schema_version: Literal["ac.proposer_reviewer.batch.v7"]
    batch_id: str
...
@dataclass(frozen=True)
class Review:
    schema_version: Literal["ac.proposer_reviewer.review.v1"]
...
@dataclass(frozen=True)
class BatchResult:
    schema_version: Literal["ac.proposer_reviewer.result.v1"]
