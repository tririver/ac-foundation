...
from ac_jobs import ExecutionFingerprint, SemanticKeyDigest, canonical_json_bytes
...
EXECUTION_RECIPE_SCHEMA = "ac.llm.execution_recipe.v3"
...
def resume_input_matches(request: LLMRequest, resume_input: ResumeInput) -> bool:
    ...
    Resume keys are opaque outside ``ac-llm``. Higher-level workflows can use
