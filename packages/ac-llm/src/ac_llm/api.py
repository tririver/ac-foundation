"""Public facades over the single task executor and ac-jobs engine."""
...
class _StandaloneInvocationContract:
    schema_version = "ac.llm.standalone_invocation.v2"
...
class LLMTaskService:
    ...
    def execute_or_resume(
        ...
        *,
        ...
        """Drive one child task without creating a nested ac-jobs run."""
...
class LLMClient:
    """Blocking standalone facade backed by a durable ac-jobs run."""
