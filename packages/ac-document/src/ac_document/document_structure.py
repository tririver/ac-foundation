...
or changes :class:`~ac_document.cached_document.CachedDocumentRef` identity.
"""
...
DOCUMENT_STRUCTURE_OVERLAY_SCHEMA = "ac.document.document_structure_overlay.v1"
CACHED_DOCUMENT_STRUCTURE_REF_SCHEMA = (
    "ac.document.cached_document_structure_ref.v1"
)
DOCUMENT_STRUCTURE_CACHE_SCHEMA = "ac.document.document_structure_cache.v1"
DOCUMENT_STRUCTURE_CONTRACT = (
    "ac.document.document_structure.qpdf_outline_markdown_alignment.v2"
)
