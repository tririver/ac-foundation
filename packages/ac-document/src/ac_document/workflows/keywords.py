...
KEYWORD_EXTRACTION_HANDLER = "ac.document.keyword_extraction.v1"
KEYWORD_REVIEW_PROMPT_CONTRACT = "ac.document.keyword_review_prompt.v1"
KEYWORD_CHAPTER_PROMPT_CONTRACT = "ac.document.keyword_chapter_prompt.v3"
EXPLICIT_TERM_SUPERVISION_SCHEMA = (
    "ac.document.explicit_term_supervision_response.v1"
)
KEYWORD_NORMALIZATION_CONTRACT = "ac.document.keyword_normalization.v1"
KEYWORD_OCCURRENCE_CONTRACT = "ac.document.keyword_occurrence_literal.v2"
KEYWORD_REVIEW_SEMANTIC_VALIDATOR = "ac.document.keyword_review_semantics.v1"
...
_REVIEW_SCHEMA: dict[str, Any] = {
    ...
    "$id": "ac.document.explicit_term_review.v1",
    "type": "object",
    "additionalProperties": False,
...
_CHAPTER_SCHEMA: dict[str, Any] = {
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "$id": "ac.document.chapter_term_extraction.v1",
    "type": "object",
    "additionalProperties": False,
    "required": ["entries"],
    "properties": {
...
class KeywordExtractionHandler:
    ...
    def semantic_input(self) -> dict[str, JsonValue]:
        value: dict[str, JsonValue] = {
            "schema_version": "ac.document.keyword_extraction_request.v1",
        ...
        if self.structure is not None:
            value["schema_version"] = "ac.document.keyword_extraction_request.v2"
...
def _explicit_supervision_pause(
    ...
    *,
    ...
    request_ref = context.artifacts.publish_json(
        ...
        {
            "schema_version": "ac.document.explicit_term_supervision_request.v1",
            "document_digest": document.document_digest,
            "field_id": field.field_id,
...
def _llm_resume_input(
    ...
    # owned by that workflow, not by ac-llm.  Only a payload that explicitly
    # claims the ac-llm resume schema belongs on this recovery path.
...
def _publish_explicit_review_invalid(
    ...
    *,
    ...
    context.artifacts.publish_json(
        _EXPLICIT_REVIEW_INVALID_ARTIFACT,
        {
            "schema_version": "ac.document.keyword_review_semantic_invalid.v1",
            "validator_contract": KEYWORD_REVIEW_SEMANTIC_VALIDATOR,
