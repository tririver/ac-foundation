...
from arc_jobs import ArtifactSourceRef, JsonValue, RunContext, StoppedError
from arc_llm import (
    JsonOutput,
    LLMCompleted,
    LLMExecutionOptions,
...
EQUATION_LABEL_VISUAL_PROMPT_VERSION = "arc.document.equation_label_visual_prompt.v1"
EQUATION_LABEL_PAGE_REVIEW_SCHEMA = "arc.document.equation_label_page_review.v1"
EQUATION_LABEL_VISUAL_DIAGNOSTIC_SCHEMA = "arc.document.equation_label_visual_diagnostic.v1"
...
def _manifest_document(
    ...
    return {
        "schema_version": "arc.document.equation_label_manifest.v1",
...
def _page_request(
    *,
    ...
    semantic = {
        ...
        "model": {"provider": model.provider, "model": model.model, "tier": model.tier},
    }
