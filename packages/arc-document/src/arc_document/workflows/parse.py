...
MARKDOWN_PDF_VISUAL_HANDLER = "arc.document.markdown_pdf_visual_parse.v1"
PARSE_OUTCOME_SCHEMA = "arc.document.parse_outcome.v1"
...
class MarkdownPDFVisualParseHandler:
    ...
    def semantic_input(self) -> dict[str, JsonValue]:
        return {
            "schema_version": "arc.document.markdown_pdf_visual_parse_request.v1",
