...
class PdftotextExtractor:
    ...
    contract_id = "arc.document.pdf_text.pdftotext.layout_utf8.v1"
    ...
    def extract(self, payload: bytes) -> PDFTextLayer:
        try:
            with tempfile.TemporaryDirectory(prefix="arc-document-pdf-") as directory:
...
class QpdfOutlineExtractor:
    ...
    contract_id = "arc.document.pdf_outline.qpdf_json.v1"
