...
class InvalidSchemaError(ArcLLMError):
    def __init__(self, message: str, *, details: Mapping[str, Any] | None = None) -> None:
        super().__init__(ErrorCode.INVALID_SCHEMA, message, details=details)


class IdempotencyConflictError(ArcLLMError):
...
class ResumeKeyMismatchError(ArcLLMError):
...
class ResumeInputConflictError(ArcLLMError):
    def __init__(self) -> None:
        super().__init__(
...
class OutputInvalidError(ArcLLMError):
...
class CandidateConflictError(ArcLLMError):
...
class ExecutionMismatchError(ArcLLMError):
    def __init__(self) -> None:
        super().__init__(
...
class AdoptionAuthorizationError(ArcLLMError):
    def __init__(self) -> None:
        super().__init__(
